...
package movimientos;
import proyecto_ajedrez.ganaste;
        public class movimientosb {
    
     String[][] tablero;
    movimientosj movimientos = new movimientosj();
    ...
    private String[] arregloFinal() {
        ...
        if (jaqueMate == true) {
            ganaste ventana = new ganaste(null, true);
    ...
    /*
    private String[] pequeñaPruebaDeFuncionamiento(){
        int maximo = 0;
        int yI = 1;
        int xI = 0;
        for(int i = 0;i<8;i++){
