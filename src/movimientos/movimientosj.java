...
public class movimientosj {
    
    String[][] tablero;
    
    private void ctablero(String[][] arr){
     for (int i = 0; i < 8; i++) {
            for (int j = 0; j < 8; j++) {
                arr[i][j] = tablero[i][j];
            }
     ...
     public boolean esPosibleEsteMovimieSnto(String[][] tablero, String posicionAntigua, String posicionNueva) {
